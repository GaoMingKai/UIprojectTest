...
class Case049(unittest.TestCase):
    ...
    def EnterOperAsse(self, driver):
        driver.find_elements_by_css_selector(".divMonitorInfo")[1].click()
        sleep(1)
        try:
    ...
    def EnterAsseSub(self, driver):
        driver.find_elements_by_css_selector(".divMonitorInfo")[2].click()
        sleep(1)
        try:
    ...
    def EnterEnergy(self, driver):
        driver.find_elements_by_css_selector(".divMonitorInfo")[3].click()
        sleep(1)
        try:
    ...
    def EnterMonitor(self, driver):
        driver.find_elements_by_css_selector(".divMonitorInfo")[4].click()
        sleep(1)
        try:
            pageOver = driver.find_element_by_id("paneCenter")
            if not pageOver:
    ...
    def EnterDiag(self, driver):
        driver.find_elements_by_css_selector(".divMonitorInfo")[5].click()
        sleep(1)
        try:
            pageOver = driver.find_element_by_id("paneCenter")
            if not pageOver:
