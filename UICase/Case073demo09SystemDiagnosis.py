...
class Case073(unittest.TestCase):
    testCaseID = 'Case073'
    projectName = "DemoEn09"
    buzName = '检查Diagnosis-System diagnosis是否正常'
    now = 'None'
    ...
    def check(self,driver):
        page=['Equipment','Diagnosis','System diagnosis']
        self.tools.enterPage(driver,page,'#indexMain', self.projectName)
        self.tools.checkNavigation(driver,self.errors,page,7)
