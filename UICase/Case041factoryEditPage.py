...
class Case041(unittest.TestCase):
    ...
    def revise(self, driver, content):
        # 修改页面内容
        sleep(2)
        # 进入到水系统测试页面
        try:
        ...
        sleep(4)
        driver.execute_script("document.getElementsByTagName('p')[0].innerHTML='" + content + "';")
        ...
        sleep(3)
        driver.find_element_by_id('inputPwd').send_keys(app.config['PASSWORD'])
