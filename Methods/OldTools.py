...
class OldTools:
    ...
    def tag_load_via_click(self, driver, case_number, itemname, tagname, taglocator):
        try:
            ...
            if tagname is None:
                self.calculateTime(driver, 'loadingMask', itemname + ":")
            else:
                self.calculateTime(driver, 'loadingMask', itemname + ">" + tagname)
        except Exception:
    ...
    def account_audit(self, driver, user_name, pw):
        ...
        self.calculateTime(browser, 'loadingMask', 'For Login')
        return browser
    ...
    def account_audit2(self, driver, user_name, pw):
        ...
        startTime = time.time()
        try:
            WebDriverWait(driver,20).until(lambda x:x.find_element_by_css_selector(".projectsCard-container"))
        except:
